...
<div class="border-b pb-6 mb-6 mt-6">
    ...
    <div class="bg-white border rounded-lg p-6 max-w-4xl mx-auto">
        ...
        @if(isset($searchResult['results']['error_message']))
            <div class="bg-red-50 border-l-4 border-red-400 p-4 mb-6">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-red-700">{{ $searchResult['results']['error_message'] }}</p>
                        <p class="text-sm text-red-700 mt-1">Google, otomatik aramaları sınırlamış olabilir. Lütfen daha sonra tekrar deneyin.</p>
                    </div>
                </div>
            </div>
        @endif
